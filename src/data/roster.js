const rosterData = [
    ...
    {
        "id": "p002", "name": "이재원", "position": "C", "hand": "R",
        "category": "포수",
        "stats": { "avg": 0.239, "probability": { "single": 0.14, "double": 0.03, "triple": 0.00, "homerun": 0.01, "walk": 0.06, "strikeout": 0.18, "groundout": 0.35, "flyout": 0.23 } }
    },
    {
        "id": "p003", "name": "박상언", "position": "C", "hand": "R",
        "category": "포수",
    ...
    // --- 내야수 (Infielders) ---
    {
        "id": "p004", "name": "채은성", "position": "1B", "hand": "R",
        "category": "내야수",
    ...
    {
        "id": "p005", "name": "문현빈", "position": "2B", "hand": "L",
        "category": "내야수",
    ...
    {
        "id": "p006", "name": "노시환", "position": "3B", "hand": "R",
        "category": "내야수",
    ...
    {
        "id": "p007", "name": "하주석", "position": "SS", "hand": "L",
        "category": "내야수",
    ...
    {
        "id": "p008", "name": "안치홍", "position": "DH", "hand": "R",
        "category": "내야수",
    ...
    {
        "id": "p009", "name": "김태연", "position": "1B", "hand": "R",
        "category": "내야수",
    ...
    {
        "id": "p010", "name": "이도윤", "position": "SS", "hand": "L",
        "category": "내야수",
    ...
    {
        "id": "p011", "name": "장진혁", "position": "2B", "hand": "R",
        "category": "내야수",
    ...
    // --- 외야수 (Outfielders) ---
    {
        "id": "p012", "name": "이진영", "position": "LF", "hand": "R",
        "category": "외야수",
    ...
    {
        "id": "p013", "name": "정은원", "position": "CF", "hand": "L",
        "category": "외야수",
    ...
    {
        "id": "p014", "name": "페라자", "position": "RF", "hand": "S",
        "category": "외야수",
    ...
    {
        "id": "p015", "name": "최인호", "position": "LF", "hand": "L",
        "category": "외야수",
    ...
    {
        "id": "p016", "name": "김강민", "position": "CF", "hand": "R",
        "category": "외야수",
    ...
    {
        "id": "p017", "name": "이원석", "position": "RF", "hand": "R",
        "category": "외야수",
    ...
    // --- 투수 (Pitchers) ---
    {
        "id": "p018", "name": "류현진", "position": "P", "hand": "L",
        "category": "투수",
    ...
    {
        "id": "p019", "name": "문동주", "position": "P", "hand": "R",
        "category": "투수",
        "stats": { "avg": 0.120, "probability": { "single": 0.08, "double": 0.01, "triple": 0.00, "homerun": 0.00, "walk": 0.02, "strikeout": 0.55, "groundout": 0.22, "flyout": 0.12 } }
    },
    {
        "id": "p020", "name": "엄상백", "position": "P", "hand": "L",
        "category": "투수",
        "stats": { "avg": 0.100, "probability": { "single": 0.07, "double": 0.01, "triple": 0.00, "homerun": 0.00, "walk": 0.02, "strikeout": 0.60, "groundout": 0.20, "flyout": 0.10 } }
    }
];
